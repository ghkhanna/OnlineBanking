...
//	@NamedQuery(name="getTransactions", query="select t from transaction t where t.account_accountNo=:accountNo")
//})
public class Transaction {
	@Id
	@GeneratedValue(strategy = GenerationType.SEQUENCE,generator="trans")
	@SequenceGenerator(name="trans", sequenceName="sequence",initialValue=1,allocationSize=0)
